          ...
          <Card className='gap-0 py-0'>
            ...
            <div className='md:hidden divide-y divide-zinc-100 dark:divide-zinc-800'>
              ...
              {filtered.map((product) => {
                const isUrgent = product.current_stock_boxes <= product.threshold;
                const isOutOfStock = product.current_stock_boxes === 0;

                return (
                  <div key={product.id} className={cn('p-4', isUrgent && 'animate-urgent-pulse')}>
                    <div className='flex items-start justify-between gap-3'>
                      ...
                      <div className='shrink-0 text-right'>
                        ...
                        <p className='mt-1 text-xs text-zinc-500'>
                          ...
                          <span className='text-zinc-400'> / {product.threshold} min</span>
                        </p>
                      </div>
                    </div>
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  {filtered.map((product) => {
                    ...
                    return (
                      <TableRow key={product.id} className={cn(isUrgent && 'animate-urgent-pulse')}>
                        <TableCell>
                          <div>
                        ...
                        <TableCell className='text-right'>
                          ...
                          <span className='text-xs text-zinc-400'> / {product.threshold} min</span>
                        </TableCell>
